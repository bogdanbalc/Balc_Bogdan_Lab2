...
namespace Balc_Bogdan_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Balc_Bogdan_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Balc_Bogdan_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
